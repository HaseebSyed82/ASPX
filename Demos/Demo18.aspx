    ...
    <form id="form1" runat="server">
        <div>
            ...
            <AlternatingItemTemplate>
                <tr class="alt">
                    <td>
                        <%# Convert.ToString(DataBinder.Eval(Container.DataItem, "EmpID"))%>
                    </td>
                    <td>
                        <%#Convert.ToString(DataBinder.Eval(Container.DataItem, "FirstName"))%>
                        <%#Convert.ToString(DataBinder.Eval(Container.DataItem, "LastName"))%>
                    </td>
                    <td>
                        <%#Convert.ToString(DataBinder.Eval(Container.DataItem, "BirthDate"))%>
                    </td>
                </tr>               
