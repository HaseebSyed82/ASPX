...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="sqlEmployees" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionDB01 %>' SelectCommand="SELECT [EmpID], [LastName], [FirstName], [EmployeeNbr] FROM [hex50Employees] ORDER BY [FullName]"></asp:SqlDataSource>
