...
public partial class Demos_Demo02 : System.Web.UI.Page
{
    ...
    protected void btnCompute_Click(object sender, EventArgs e)
    {
        ...
        if (rblPeriod.SelectedValue == "years")
            payPeriods = Convert.ToDouble(txtYearsOrMonth.Text) * PAYMENTS_PER_YEAR;
        else
            payPeriods = Convert.ToDouble(txtYearsOrMonth.Text);
    ...
    {
        litYearsOrMonth.Text = rblPeriod.SelectedValue;

        if (rblPeriod.SelectedValue == "months")
        {
            rgvtxtYearsOrMonth.ErrorMessage = "Period must be between 12 and 1188";
            rgvtxtYearsOrMonth.MinimumValue = "12";
            rgvtxtYearsOrMonth.MaximumValue = "1188";
        }
        else
        {
            rgvtxtYearsOrMonth.ErrorMessage = "Period must be between 1 and 99";
            rgvtxtYearsOrMonth.MinimumValue = "1";
            rgvtxtYearsOrMonth.MaximumValue = "99";
        }
        Page.Validate();
    }
}