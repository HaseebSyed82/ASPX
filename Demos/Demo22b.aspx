...
<head runat="server">
    <title>Demo 22 - Detail Page</title>
</head>

<body>
    <form id="form1" runat="server">
        <div>
            <h1>Demo 22 - Detail Page</h1>
            <br /><br />

            <asp:SqlDataSource ID="sqlEmployee" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionDB01 %>' SelectCommand="SELECT [EmpID], [LastName], [FirstName], [BirthDate], [SSN], [EmployeeNbr], [FullName] FROM [hex50Employees] WHERE ([EmpID] = @EmpID)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="sqlDependants" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionDB01 %>' SelectCommand="SELECT [EmpID], [DependentNbr], [LastName], [FirstName], [BirthDate], [SSN], [FullName] FROM [hex50Dependents] WHERE ([EmpID] = @EmpID) ORDER BY [LastName], [FirstName]">
                <SelectParameters>
                    <asp:QueryStringParameter QueryStringField="EmpID" Name="EmpID" Type="Decimal"></asp:QueryStringParameter>
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:GridView ID="grdDependants" runat="server" DataSourceID="sqlDependants" AutoGenerateColumns="False" DataKeyNames="EmpID,DependentNbr">
                <Columns>
